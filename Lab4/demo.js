...
function CalculateCommission()
{
    ...
    alert("The top salesperson is " + topSalesPerson + ", with the top comission of " + topCommission + ".");
    console.log("____________________________________________________________________");
    console.log("The top salesperson is " + topSalesPerson + ", with the top comission of " + topCommission + ".");
    console.log("____________________________________________________________________");
